...
//	STATUS 상태값(Y/N)
	...
	public Attachment(int fileNo, int refBno, int refMno, String originName, String changeName, String filePath,
	...
	public String toString() {
		return "Attachment [fileNo=" + fileNo + ", refBno=" + refBno + ", refMno=" + refMno + ", originName="
